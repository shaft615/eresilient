export const metadata = {
  ...
  description:
    "What business continuity planning actually looks like for SMBs in 2026 — what to include, what to skip, where templates fail, and when to bring in outside help. Practitioner-grade guidance from 30+ years of Fortune 100 BCM.",
